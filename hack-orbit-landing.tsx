  ...
  <div className="max-w-7xl mx-auto text-center relative">
    ...
    {(() => {
      const teamMembers = [
        ...
        { row: 2, name: "Shiv Shrivastava", role: "PRESIDENT", organization: "DLG GROUP", color: "blue", icon: Users, imageUrl: "[https://i.ibb.co/wh9BRgnk/download.jpg", portfolioUrl: "https://www.linkedin.com/in/shiv-shrivastava-4137bb268/" },
